...
module FastCommentsClient
  class User
    ...
    attr_accessor :agent_approval_notification_frequency
    ...
    def self.openapi_types
      {
        ...
        :'agent_approval_notification_frequency' => :'ImportedAgentApprovalNotificationFrequency',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'agent_approval_notification_frequency')
        self.agent_approval_notification_frequency = attributes[:'agent_approval_notification_frequency']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          agent_approval_notification_frequency == o.agent_approval_notification_frequency &&
