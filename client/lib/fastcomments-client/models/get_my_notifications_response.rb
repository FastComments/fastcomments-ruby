...
module FastCommentsClient
  class GetMyNotificationsResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FastCommentsClient::GetMyNotificationsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FastCommentsClient::GetMyNotificationsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @is_subscribed.nil?
        invalid_properties.push('invalid value for "is_subscribed", is_subscribed cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_subscribed.nil?
    ...
    # @param [Object] is_subscribed Value to be assigned
    def is_subscribed=(is_subscribed)
      if is_subscribed.nil?
        fail ArgumentError, 'is_subscribed cannot be nil'
      end
    ...
    def hash
      [translations, is_subscribed, has_more, notifications, status].hash
    end
