...
module FastCommentsClient
  class TenantPackage < ApiModelBase
    ...
    attr_accessor :flex_llm_cost_cents

    attr_accessor :flex_llm_unit
    ...
    attr_accessor :has_ai_agents

    attr_accessor :max_ai_agents

    attr_accessor :ai_agent_daily_budget_cents
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'flex_llm_cost_cents')
        self.flex_llm_cost_cents = attributes[:'flex_llm_cost_cents']
      end

      if attributes.key?(:'flex_llm_unit')
        self.flex_llm_unit = attributes[:'flex_llm_unit']
      end
      ...
      if attributes.key?(:'has_ai_agents')
        self.has_ai_agents = attributes[:'has_ai_agents']
      end

      if attributes.key?(:'max_ai_agents')
        self.max_ai_agents = attributes[:'max_ai_agents']
      end

      if attributes.key?(:'ai_agent_daily_budget_cents')
        self.ai_agent_daily_budget_cents = attributes[:'ai_agent_daily_budget_cents']
      end

      if attributes.key?(:'ai_agent_monthly_budget_cents')
        self.ai_agent_monthly_budget_cents = attributes[:'ai_agent_monthly_budget_cents']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flex_llm_cost_cents == o.flex_llm_cost_cents &&
          flex_llm_unit == o.flex_llm_unit &&
          ...
          has_ai_agents == o.has_ai_agents &&
          max_ai_agents == o.max_ai_agents &&
          ai_agent_daily_budget_cents == o.ai_agent_daily_budget_cents &&
          ai_agent_monthly_budget_cents == o.ai_agent_monthly_budget_cents
    end
