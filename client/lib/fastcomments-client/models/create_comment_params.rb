...
module FastCommentsClient
  class CreateCommentParams < ApiModelBase
    attr_accessor :date
    ...
    def self.openapi_types
      {
        ...
        :'question_values' => :'Hash<String, GifSearchResponseImagesInnerInner>',
        :'tos' => :'Boolean',
        :'bot_id' => :'String',
        :'approved' => :'Boolean',
        :'domain' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FastCommentsClient::CreateCommentParams` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FastCommentsClient::CreateCommentParams`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
