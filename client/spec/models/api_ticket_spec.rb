...
# Unit tests for FastCommentsClient::APITicket
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FastCommentsClient::APITicket do
  let(:instance) { FastCommentsClient::APITicket.new }

  describe 'test an instance of APITicket' do
    it 'should create an instance of APITicket' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FastCommentsClient::APITicket)
    end
  end
