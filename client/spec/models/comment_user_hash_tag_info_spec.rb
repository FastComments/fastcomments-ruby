...
# Unit tests for FastCommentsClient::CommentUserHashTagInfo
...
describe FastCommentsClient::CommentUserHashTagInfo do
  ...
  describe 'test an instance of CommentUserHashTagInfo' do
    it 'should create an instance of CommentUserHashTagInfo' do
      ...
      #expect(instance).to be_instance_of(FastCommentsClient::CommentUserHashTagInfo)
    end
  end
  ...
  describe 'test attribute "retain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
