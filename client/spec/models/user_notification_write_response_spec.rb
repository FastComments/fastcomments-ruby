...
# Unit tests for FastCommentsClient::UserNotificationWriteResponse
...
describe FastCommentsClient::UserNotificationWriteResponse do
  ...
  describe 'test an instance of UserNotificationWriteResponse' do
    it 'should create an instance of UserNotificationWriteResponse' do
      ...
      #expect(instance).to be_instance_of(FastCommentsClient::UserNotificationWriteResponse)
    end
  end
  ...
  describe 'test attribute "modified_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
