...
# Unit tests for FastCommentsClient::VoteDeleteResponse
...
describe FastCommentsClient::VoteDeleteResponse do
  ...
  describe 'test an instance of VoteDeleteResponse' do
    it 'should create an instance of VoteDeleteResponse' do
      ...
      #expect(instance).to be_instance_of(FastCommentsClient::VoteDeleteResponse)
    end
  end
  ...
  describe 'test attribute "was_pending_vote"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
