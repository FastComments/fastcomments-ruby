...
# Unit tests for FastCommentsClient::UpdateTenantBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FastCommentsClient::UpdateTenantBody do
  #let(:instance) { FastCommentsClient::UpdateTenantBody.new }

  describe 'test an instance of UpdateTenantBody' do
    it 'should create an instance of UpdateTenantBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FastCommentsClient::UpdateTenantBody)
    end
  end
